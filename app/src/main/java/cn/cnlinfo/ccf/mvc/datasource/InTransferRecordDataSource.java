...
public class InTransferRecordDataSource implements IAsyncDataSource<List<TransferRecordEntity>> {
    private int page = 1 ;
    ...
    private RequestHandle loadOutTransferRecord(final ResponseSender<List<TransferRecordEntity>> sender, final int page){
        ...
        HttpRequest.post(Constant.RECORD_CENTER_HOST + API.INOUTTRANSFERRECORD, params, new CCFHttpRequestCallback() {
            ...
            protected void onDataSuccess(JSONObject data) {
                ...
                InTransferRecordDataSource.this.page = page;
                InTransferRecordDataSource.this.maxPage = data.getIntValue("PageCount");
