...
public class StepArcView extends View {
     ...
     * 画步数的数值的字体大小
     */
    private float numberTextSize = dipToPx(16);
    /**
     * 步数
     */
     ...
     * 动画时长
     */
    private int animationInterval = 3000;
    ...
    private void drawArcYellow(Canvas canvas, RectF rectF) {
        ...
        /** 默认画笔颜色，黄色 */
        paint.setColor(getResources().getColor(R.color.color_yellow_fbb673));
        /** 结合处为圆弧*/
    ...
    private void drawTextStepString(Canvas canvas, float centerX) {
        ...
        vTextPaint.setTextAlign(Paint.Align.CENTER);
        vTextPaint.setAntiAlias(true);//抗锯齿功能
        vTextPaint.setColor(getResources().getColor(R.color.color_gray_8b8c8d));
